...
public class Exchange extends JFrame {
    ...
    protected Map<String, String> currencyLabelKey = new HashMap<>();
    ...
    protected final int[] labelIndex = {0, 1, 2, 3, 4};
    ...
    private void setMatrixPanel() {
        matrixPanel.setBounds(220, 10, 480, 190);
    ...
    private void setCGraphLabel() {
        cGraphLabel.setBounds(130, 260, 300, 17);
    ...
    private void setNegativeGraphPanel() {
        negativeGraphPanel.setBounds(450, 280, 450, 450);
    ...
    private void setNGraphLabel() {
        nGraphLabel.setBounds(580, 260, 300, 17);
