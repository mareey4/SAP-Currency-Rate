...
public class BellmanFord{
    ...
    public static List<String> findNegativeCycle(Rate[][] rates) {
    ...
    List<String> negativeCycle = new ArrayList<>();
        ...
        for (int j = 0; j < numCountries; j++) {
            if (i != j) {
                ...
                for (int k = 0; k < numCountries; k++) {
                    ...
                    negativeCycle.add(rates[start][i].from); // Add country to the cycle
    ...
    public static List<String> findArbitrageOpportunity(Rate[][] rates) {
        int numCountries = rates.length;
        ...
        List<String> arbitrageOpportunity = new ArrayList<>();
        ...
        for (int i = 0; i < numCountries; i++) {
            if (distances[i][i] > 1.0) {
                ...
                for (int j = 0; j < numCountries; j++) {
                    ...
                    arbitrageOpportunity.add(rates[start][i].from); // Add country to the cycle
                    if (start == i && visited.size() >= 3) {
